                             ...
                             const char *arg_)
{
    ...
    apn_set_unsupport(cmd, "SSLMutex: No relevant directive in Nginx.");
    return NULL;
}
                                  ...
                                  const char *arg3)
{
    ...
    apn_set_unsupport(cmd, "SSLRandomSeed: No relevant directive in Nginx.");
    return NULL;
}
...
const char *ssl_cmd_SSLFIPS(cmd_parms *cmd, void *dcfg, int flag)
{
    ...
    apn_set_unsupport(cmd, "SSLFIPS: No relevant directive in Nginx.");
    return NULL;
}
                                   ...
                                   const char *arg)
{
    ...
    if (cmd->path) {
        ...
        apn_set_unsupport(cmd, "Not supported in Nginx location section.");
    }
    else {
                                       ...
                                       const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLCADNRequestPath: No relevant directive in Nginx.");
    return NULL;
}
                                       ...
                                       const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLCADNRequestFile: No relevant directive in Nginx.");
    return NULL;
}
                                        ...
                                        const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLCARevocationPath: No relevant directive in Nginx.");
    return NULL;
}
                                    ...
                                    const char *arg)
{
    ...
    if (strcEQ(arg, "none")) {
        ...
        apn_set_unsupport(cmd, "SSLSessionCache: Argument dbm: not supported in Nginx.");
    }
...
#endif
        apn_set_unsupport(cmd, "SSLSessionCache: Argument dc: not supported in Nginx.");
    }
    else {
        return "SSLSessionCache: Invalid argument";
    }
                               ...
                               const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLOptions: No relevant directive in Nginx.");
    return NULL;
}
...
const char *ssl_cmd_SSLRequireSSL(cmd_parms *cmd, void *dcfg)
{
    ...
    apn_set_unsupport(cmd, "SSLRequireSSL: No relevant directive in Nginx.");
    return NULL;
}
...
const char *ssl_cmd_SSLRenegBufferSize(cmd_parms *cmd, void *dcfg, const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLRenegBufferSize: No relevant directive in Nginx.");
    return NULL;
}
...
const char *ssl_cmd_SSLProxyEngine(cmd_parms *cmd, void *dcfg, int flag)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyEngine: No relevant directive in Nginx.");
    return NULL;
}
                                     ...
                                     const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyProtocol: No relevant directive in Nginx.");
                                        ...
                                        const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyCipherSuite: No relevant directive in Nginx.");
    return NULL;
}
                                   ...
                                   const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyVerify: No relevant directive in Nginx.");
    return NULL;
}
                                        ...
                                        const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyVerifyDepth: No relevant directive in Nginx.");
    return NULL;
}
                                              ...
                                              const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyCACertificateFile: No relevant directive in Nginx.");
    return NULL;
}
                                              ...
                                              const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyCACertificatePath: No relevant directive in Nginx.");
    return NULL;
}
                                             ...
                                             const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyCARevocationPath: No relevant directive in Nginx.");
    return NULL;
}
                                             ...
                                             const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyCARevocationFile: No relevant directive in Nginx.");
    return NULL;
}
                                                   ...
                                                   const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyMachineCertificateFile: No relevant directive in Nginx.");
    return NULL;
}
                                                   ...
                                                   const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyMachineCertificatePath: No relevant directive in Nginx.");
    return NULL;
}
                                ...
                                const char *arg)
{
    ...
    apn_set_unsupport(cmd, "SSLUserName: No relevant directive in Nginx.");
    return NULL;
}
...
const char *ssl_cmd_SSLProxyCheckPeerExpire(cmd_parms *cmd, void *dcfg, int flag)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyCheckPeerExpire: No relevant directive in Nginx.");
    return NULL;
}
...
const char *ssl_cmd_SSLProxyCheckPeerCN(cmd_parms *cmd, void *dcfg, int flag)
{
    ...
    apn_set_unsupport(cmd, "SSLProxyCheckPeerCN: No relevant directive in Nginx.");
    return NULL;
}
...
const char  *ssl_cmd_SSLStrictSNIVHostCheck(cmd_parms *cmd, void *dcfg, int flag)
{
    ...
    apn_set_unsupport(cmd, "SSLStrictSNIVHostCheck: No relevant directive in Nginx.");
    return NULL;
#else
