...
static const char * set_string_slot(cmd_parms *cmd,
        void *struct_ptr,
        const char *arg)
{
    apn_set_unsupport(cmd, MSG_NO_RELEVANT);
...
static void* convert_autoindex_dir_config( apr_pool_t *p, 
                                     cmd_parms *parms,
                                     ap_conf_vector_t* v )
{
    autoindex_config_rec *dconf = ap_get_module_config(v, &autoindex_module);
...
module AP_MODULE_DECLARE_DATA autoindex_module =
{
    ...
    convert_autoindex_dir_config, /* convert per dir config structure */
