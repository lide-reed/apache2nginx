...
/** added by Reed */
/* TODO we need to define micro HAVE_GETPWUID
 * in apr_private.h and ap_config_auto.h.in.
 * then using HAVE_GETPWUID instead.
 */
/*#ifdef HAVE_GETPWUID*/
AP_DECLARE(const char*) ap_uid2name(uid_t uid)
{
    struct passwd *ent;
...
/** added by Reed */
/* TODO we need to define micro HAVE_GETGRGID 
 * in apr_private.h and ap_config_auto.h.in.
 * then using HAVE_GETGRGID instead.
 */
/*#ifdef HAVE_GETGRGID*/
AP_DECLARE(const char*) ap_gid2name(gid_t gid)
{
    struct group *ent;
